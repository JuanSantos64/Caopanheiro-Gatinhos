...
const AddAnimalPage = ({ navigation, route }) => {
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View>
        ...
        <Text style={styles.bodyText}>Quais as caracteristicas do seu animal?</Text>
      </View>
      <View>
      ...
      <View style={styles.body}>
        <Pressable onPress={() => navigation.navigate('CatalogPage')} style={styles.inicialbutton}>
          <Text style={styles.textoButton}>Adicionar {animalName}!</Text>
        </Pressable>
      </View>
    </SafeAreaView>
  );
